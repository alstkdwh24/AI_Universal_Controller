        ...
        <div className="modelLogin" style={{ display: 'flex' }} onClick={onClose}>
            <div className="modelJoin" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modelJoinSocial">
                    <div className="socialJoin-kakao" onClick={() => handleSocialLogin(`${CONFIG.AI_MEMBERSECURITY}/oauth2/authorization/kakao`)}>
                    ...
                    <div className="socialJoin-naver" onClick={() => handleSocialLogin(`${CONFIG.AI_MEMBERSECURITY}/oauth2/authorization/naver`)}>
                        <div className="socialJoins-round">
                            <img src="/image/naver_login.png" alt="네이버 로그인" className="login-logo" />
                        </div>
                        <div className="socialJoins-name">네이버 로그인</div>
                    </div>
                    <div className="socialJoin-google" onClick={() => handleSocialLogin(`${CONFIG.AI_MEMBERSECURITY}/oauth2/authorization/google`)}>
                        <div className="socialJoins-round">
                            <img src="/image/google_login.png" alt="구글 로그인" className="login-logo login-google" />
                        </div>
                        <div className="socialJoins-name">구글 로그인</div>
                    </div>
                    <div className="socialJoin-facebook" onClick={() => handleSocialLogin(`${CONFIG.AI_MEMBERSECURITY}/oauth2/authorization/facebook`)}>
                        <div className="socialJoins-round">
                            <img src="/image/facebook_login.png" alt="페이스북 로그인" className="login-logo" />
                        </div>
                        <div className="socialJoins-name">페이스북 로그인</div>
                    </div>
                    <div className="socialJoin-github" onClick={() => handleSocialLogin(`${CONFIG.AI_MEMBERSECURITY}/oauth2/authorization/github`)}>
                        <div className="socialJoins-round">
